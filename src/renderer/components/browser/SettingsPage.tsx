...
import { PasswordManagerSettings } from "./PasswordManagerSettings";
...
const categoryGroups: CategoryGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "passwords", label: "Passwords & Autofill", detail: "Local encrypted vault", icon: <KeyRound /> },
...
const settingsSearchIndex: Record<SettingsCategoryId, string> = {
  ...
  passwords:
    "password manager passwords autofill master password vault generator import export auto-lock clipboard encrypted backup",
  permissions:
...
function CategoryContent({
  ...
  const diagnosticsPayload = () => ({
    ...
    app: {
      ...
      version: runtimeInfo?.appVersion ?? "1.1.10-DevU",
        ...
        JSON.stringify(
          {
            ...
            appVersion: runtimeInfo?.appVersion ?? "1.1.10-DevU",
            settings,
          },
          null,
          2,
  ...
  const addPermissionException = () => {
    const origin = normalizeHttpOrigin(permissionHost, true);
    if (!origin) {
      setSecurityNotice("Enter a valid origin such as https://example.com.");
      return;
    }

    const nextExceptions = [
      {
        id: `${origin}-${permissionType}`,
        origin,
      ...
      ...settings.sitePermissionExceptions.filter(
        (item) => !(item.origin === origin && item.permission === permissionType),
      ),
    ].slice(0, 80);

    onUpdateSettings({ sitePermissionExceptions: nextExceptions });
    setPermissionHost("");
    setSecurityNotice(`${origin} exception saved.`);
  };
  ...
  switch (category) {
        ...
        <>
          ...
          <SettingSection title="Maintenance" detail="Portable settings actions that exclude private site data.">
            ...
            <ActionRow
              ...
              detail="Restore preferences to the 1.1.10-DevU defaults."
              actionLabel="Reset"
              ...
              onAction={() =>
                requestConfirm(
                  ...
                  "This restores preferences to the 1.1.10-DevU defaults.",
                  "Reset",
                  onResetSettings,
                )
              }
          ...
          <StatusCard
            ...
            detail={`UltraX Browser ${runtimeInfo?.appVersion ?? "1.1.10-DevU"} is running in ${
        ...
        <>
          ...
          <SettingSection title="Security Actions" detail="Reset or inspect release trust information.">
            ...
            <ActionRow
              ...
              detail="Restores only security preferences to the 1.1.10-DevU defaults."
              actionLabel="Reset"
              icon={<RotateCcw aria-hidden="true" />}
              danger
              onAction={() =>
                requestConfirm(
                  ...
                  "Only Security page preferences will return to the 1.1.10-DevU defaults.",
                  "Reset",
      ...
      return (
        <>
          ...
          <SettingSection title="Site Exceptions" detail="Per-site permission decisions override the defaults above.">
            <TextRow
              label="Site"
              detail="Use an origin such as https://example.com or https://example.com:8443."
            ...
            {settings.sitePermissionExceptions.length === 0 ? (
              ...
              settings.sitePermissionExceptions.map((exception) => (
                <div key={exception.id} className="settings-row">
                  <RowText
                    label={`${exception.origin} - ${permissionLabels[exception.permission]}`}
          ...
          <SettingSection title="Runtime Coverage" detail="What is enforced in 1.1.10-DevU and what stays under Chromium defaults.">
    ...
    case "profiles":
      return (
        <>
          ...
          <EmptyFeature title="Profiles are coming next" detail="1.1.10-DevU keeps the Settings structure ready without adding speculative account logic." icon={<UserRound aria-hidden="true" />} />
        </>
      );
    ...
    case "plugins":
      return (
        <>
          ...
          <EmptyFeature title="Plugin system not enabled" detail="UltraX Browser 1.1.10-DevU keeps Plugins separate while browser Extensions and updates mature." icon={<Puzzle aria-hidden="true" />} />
        </>
      );
      ...
      return (
        <>
          ...
          <SettingSection title="Diagnostics" detail="Local performance information safe to copy or export.">
            <InfoRow label="App version" detail={`UltraX Browser ${runtimeInfo?.appVersion ?? "1.1.10-DevU"}`} />
            ...
            <ActionRow
              ...
              detail="Restores only this Performance page to 1.1.10-DevU defaults."
              actionLabel="Reset"
              icon={<RotateCcw aria-hidden="true" />}
              danger
              onAction={() =>
                requestConfirm(
                  ...
                  "Only the Performance page settings will return to the 1.1.10-DevU defaults.",
                  "Reset",
      ...
      return (
        <>
          ...
          <SettingSection title="Visual Comfort" detail="Improve readability without changing the UltraX identity.">
            ...
            />
            <InfoRow label="UI Scale" detail="Planned after responsive layout testing; Text Size is safe in 1.1.10-DevU." />
            <RangeRow
    ...
    case "passwords":
      return <PasswordManagerSettings settings={settings} onUpdateSettings={onUpdateSettings} />;
    ...
    case "updates": {
      const update = updateStatus ?? {
        status: "idle",
        currentVersion: runtimeInfo?.appVersion ?? "1.1.10-DevU",
    ...
    case "about":
      return (
        <>
          ...
          <InfoRow label="App" detail={`UltraX Browser ${runtimeInfo?.appVersion ?? "1.1.10-DevU"}`} />
            <InfoRow label="Electron" detail={runtimeInfo?.electronVersion ?? "Unknown"} />
            <InfoRow label="Chromium" detail={runtimeInfo?.chromiumVersion ?? "Unknown"} />
            <InfoRow label="Node" detail={runtimeInfo?.nodeVersion ?? "Unknown"} />
            <InfoRow
